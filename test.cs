...
namespace API
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // string urlStr = null;
            // string requestData="{\"tracking_number\":\"300523068159\"}";
            ...
            // string urlStr = "?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=1541314361&numbers=300523068159&orders=&lang=en";
            // string requestData = null;
            // string result = new Tracker().getOrderTracesByJson(requestData, urlStr, "get");

            // 5 Get tracking results of a single tracking.
            // string urlStr = "/4px/300523068159/en";
            // string requestData = null;
            ...
            // string urlStr = "/4px/300523068159";
            ...
            // string urlstr = null;
            // string requestdata = "{\"tracking_number\": \"300523068159\",\"carrier_code\":\"4px\",\"destination_code\":\"{destination_code}\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
            // string result = new Tracker().getOrderTracesByJson(requestdata, urlstr, "realtime");

            // 10 Modify courier code
            // string   urlStr =null;
            // string requestData="{\"tracking_number\": \"300523068159\",\"carrier_code\":\"4px\",\"update_carrier_code\":\"china-ems\"}";
            ...
            // string   urlStr =null;
            // string requestData= "[{\"tracking_number\":\"300523068159\",\"carrier_code\":\"4px\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
            ...
            // string   urlStr =null;
            // string requestData= "[{\"carrier_code\":\"4px\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
